...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4543&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ic10trainingdata-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ic10trainingdata` can be installed with `conda`:
...
```
mamba install r-ic10trainingdata
```

It is possible to list all of the versions of `r-ic10trainingdata` available on your platform with `conda`:
...
```
mamba search r-ic10trainingdata --channel conda-forge
```
...
mamba repoquery search r-ic10trainingdata --channel conda-forge

# List packages depending on `r-ic10trainingdata`:
mamba repoquery whoneeds r-ic10trainingdata --channel conda-forge

# List dependencies of `r-ic10trainingdata`:
mamba repoquery depends r-ic10trainingdata --channel conda-forge
```
